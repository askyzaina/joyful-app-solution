...
const Hero = () => {
  return (
    <div className="relative overflow-hidden pt-20 pb-16 md:pt-32 md:pb-24 before:content-[''] before:absolute before:inset-0 before:bg-malware-grid before:bg-cover before:bg-center before:opacity-50 before:z-0">
      {/* Dark overlay with improved gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/90 via-[#0c0921]/90 to-background z-0"></div>
      ...
      <div className="absolute -z-10 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl top-20 -right-48 animate-pulse-soft"></div>
      <div className="absolute -z-10 w-96 h-96 bg-purple-600/15 rounded-full blur-3xl -bottom-48 -left-48 animate-pulse-soft" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="container max-w-7xl relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <div className="inline-block px-4 py-1.5 mb-6 rounded-full bg-gradient-to-r from-purple-700 via-purple-600 to-purple-800 text-white text-sm font-bold tracking-wide shadow-lg transform hover:scale-105 transition-all duration-300 animate-pulse-soft relative overflow-hidden group font-mono">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-fade-in text-white" style={{ animationDelay: '0.1s' }}>
              Bebaskan Website Anda <br/>Dari <span className="bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent">Malware</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <CTAButton to="/kontak" size="lg" className="bg-gradient-to-r from-purple-700 to-purple-900 hover:from-purple-800 hover:to-purple-950 animate-glow">
                Konsultasi Gratis
                <ArrowRight className="ml-2 h-4 w-4" />
              </CTAButton>
              <Button variant="outline" size="lg" asChild className="border-purple-600/50 bg-transparent text-white hover:bg-purple-900/50 hover:text-purple-200 transition-colors duration-300 backdrop-blur-sm">
          ...
          <div className="w-full lg:w-1/2 relative animate-fade-in-up">
            <div className="aspect-[4/3] bg-gradient-to-br from-black/90 to-purple-950/60 rounded-2xl shadow-xl overflow-hidden glass-card p-6 md:p-8 backdrop-blur border border-purple-500/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-4 rounded-xl bg-black/60 backdrop-blur-sm flex items-start animate-slide-in-left group hover:bg-purple-900/40 transition-colors duration-300 border border-purple-500/10" style={{ animationDelay: '0.4s' }}>
                ...
                <div className="p-4 rounded-xl bg-black/60 backdrop-blur-sm flex items-start animate-slide-in-right group hover:bg-purple-900/40 transition-colors duration-300 border border-purple-500/10" style={{ animationDelay: '0.5s' }}>
                ...
                <div className="p-4 rounded-xl bg-black/60 backdrop-blur-sm flex items-start animate-slide-in-left group hover:bg-purple-900/40 transition-colors duration-300 border border-purple-500/10" style={{ animationDelay: '0.6s' }}>
                ...
                <div className="p-4 rounded-xl bg-black/60 backdrop-blur-sm flex items-start animate-slide-in-right group hover:bg-purple-900/40 transition-colors duration-300 border border-purple-500/10" style={{ animationDelay: '0.7s' }}>
            ...
            <div className="absolute -z-10 w-72 h-72 bg-purple-600/20 rounded-full blur-3xl top-0 right-0 transform translate-x-1/3 -translate-y-1/3"></div>
            <div className="absolute -z-10 w-72 h-72 bg-purple-700/15 rounded-full blur-3xl bottom-0 left-0 transform -translate-x-1/3 translate-y-1/3"></div>
